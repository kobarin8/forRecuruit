...
// getProductInfoList()																															で使用
// getProductInfo(int productId)																												で使用
// getProductInfoListByCategoryId(int categoryId, int productId, int limitOffset,int limitRowCount)		単語検索＆カテゴリ指定で使用
// getProductInfoListAll(String[] keywordsList)																						で使用
// getProductInfoListByKeywords(String[] keywordsList, String categoryId)											単語検索のみで使用
